...
Config.Points = {
	...
	-- STAFF
	--{"steam:11000010dbee8b6", 100000}, -- ikNox

	-- VIP

	--{"steam:", 150}, -- Balthazar Wyalt date prochain paiement 06/03/2020
}
...
Config.whitelist = "Vous n'êtes pas sur la WhiteList de ce serveur"
