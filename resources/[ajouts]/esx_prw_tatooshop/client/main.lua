...
Citizen.CreateThread(function()
    ...
    ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_prisoner_01", 1636.24, 2550.30, 44.56, 53.64, false, true)
...
Citizen.CreateThread(function()
    ...
    ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_prisoner_01", 1633.56, 2547.82, 44.56, 53.64, false, true)
    SetBlockingOfNonTemporaryEvents(ped, true)
    SetEntityInvincible(ped, true)
    FreezeEntityPosition(ped, true)
end)
