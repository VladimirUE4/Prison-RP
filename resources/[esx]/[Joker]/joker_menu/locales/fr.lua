Locales['fr'] = {
  ...
  -- Menu Notification
  ['missing_rights'] = 'Vous n\'avez pas les ~w~droits~w~',
  ...
  ['admin_noclipon'] = 'NoClip ~w~activé',
  ['admin_noclipoff'] = 'NoClip ~w~désactivé',
  ['admin_godmodeon'] = 'Mode invincible ~w~activé',
  ['admin_godmodeoff'] = 'Mode invincible ~w~désactivé',
  ['admin_ghoston'] = 'Mode fantôme ~w~activé',
  ['admin_ghostoff'] = 'Mode fantôme ~w~désactivé',
  ['admin_vehicleflip'] = 'Voiture retourné',
  ['admin_tpmarker'] = 'Téléporté sur le marqueur !',
  ['admin_nomarker'] = 'Pas de marqueur sur la carte !',

  -- Main Menu
  ['mainmenu_subtitle'] = '👻 • ~w~Menu Interaction',
  ['mainmenu_gps_button'] = '🗺 • ~w~GPS',
  ['mainmenu_approach_button'] = '🏃🏽‍ • ~w~Démarche',
  ['mainmenu_voice_button'] = '🔉 • ~w~Voix',
  ['gps'] = 'GPS: %s',
  ['approach'] = '🏃🏽‍ • ~w~Démarche: %s',
  ['voice'] = 'Voix: ~w~%s',
  ...
  -- Wallet Menu
	['wallet_title'] = '👛 • ~w~Portefeuille',
	['wallet_option_give'] = 'Donner',
	['wallet_option_drop'] = 'Jeter',
	['wallet_job_button'] = '🏭 • Métier: ~w~%s - %s',
	['wallet_job2_button'] = '🏴 • Organisation: ~w~%s - %s',
	['wallet_money_button'] = '💸 • Argent: ~g~%s$',
	['wallet_bankmoney_button'] = '🏦 • Banque: ~b~%s',
	['wallet_blackmoney_button'] = '💰 • Argent Sale: ~r~%s$',
	['wallet_show_idcard_button'] = '📃 • Montrer sa ~w~carte d\'identité',
	['wallet_check_idcard_button'] = '📃 • Regarder sa ~w~carte d\'identité',
	['wallet_show_driver_button'] = '📃 • Montrer son ~w~permis de conduire',
	['wallet_check_driver_button'] = '📃 • Regarder son ~w~permis de conduire',
	['wallet_show_firearms_button'] = '📃 • Montrer son ~w~permis port d\'armes',
	['wallet_check_firearms_button'] = '📃 • Regarder son ~w~permis port d\'armes',

  -- Bills Menu
  ['bills_title'] = '📝 • ~w~Factures',

  -- Clothes Menu
	['clothes_title'] = '👚 • ~w~Vêtements',
	['clothes_top'] = '👕 • Mettre/Retirer Haut',
	['clothes_pants'] = '👖 • Mettre/Retirer Bas',
	['clothes_shoes'] = '👟 • Mettre/Retirer Chaussures',
	['clothes_bag'] = '👜 • Mettre/Retirer Sac',
	['clothes_bproof'] = '🦺 • Mettre/Retirer Gilet par Balle',

  -- Accessories Menu
	['accessories_title'] = '🎭 • ~w~Accessoires',
	['accessories_ears'] = '👂 • ~w~Mettre/Retirer Accessoire d\'Oreilles',
	['accessories_glasses'] = '😎 • ~w~Mettre/Retirer Lunettes',
	['accessories_helmet'] = '⛑️ • ~w~Mettre/Retirer Chapeau/Casque',
	['accessories_mask'] = '😷 • ~w~Mettre/Retirer Masque',

  -- Animation Menu
	['animation_title'] = '🕺🏽 • ~w~Animations',
  ...
  -- Vehicle Menu
  ['vehicle_title'] = '🔧 • ~w~Gestion Véhicule',
  ...
  -- Boss Management Menu
	['bossmanagement_title'] = '🏭 • ~w~Gestion Entreprise: %s',
  ...
  -- Boss Management 2 Menu
	['bossmanagement2_title'] = '🏴 • ~w~Gestion Organisation: %s',
	['bossmanagement2_chest_button'] = '🧰 • Coffre Organisation:',
	['bossmanagement2_hire_button'] = '📑 • Recruter',
	['bossmanagement2_fire_button'] = '🛑 • Virer',
	['bossmanagement2_promote_button'] = '↗️ • Promouvoir',
	['bossmanagement2_demote_button'] = '🛑 • Destituer',

  -- Admin Menu
  ['admin_title'] = '~w~👻 • Administration',
  ['admin_goto_button'] = '~w~TP sur Joueur',
  ['admin_bring_button'] = '~w~TP Joueur sur moi',
  ['admin_tpxyz_button'] = '~w~TP sur Coordonées',
  ['admin_noclip_button'] = '~w~NoClip',
  ['admin_godmode_button'] = '~w~Mode Invincible',
  ['admin_ghostmode_button'] = '~w~Mode Fantôme',
  ['admin_spawnveh_button'] = '~w~Faire apparaître un Véhicule',
  ['admin_repairveh_button'] = '~w~Réparer Véhicule',
  ['admin_flipveh_button'] = '~w~Retourner le véhicule',
  ['admin_givemoney_button'] = '~w~S\'octroyer de l\'argent',
  ['admin_givebank_button'] = '~w~S\'octroyer de l\'argent (banque)',
  ['admin_givedirtymoney_button'] = '~w~S\'octroyer de l\'argent sale',
  ['admin_showxyz_button'] = '~w~Afficher/Cacher Coordonnées',
  ['admin_showname_button'] = '~w~Afficher/Cacher Noms des Joueurs',
  ['admin_tpmarker_button'] = '~w~TP sur le Marqueur',
  ['admin_revive_button'] = '~w~Réanimer un Joueur',
  ['admin_changeskin_button'] = '~w~Changer l\'Apparence',
  ['admin_saveskin_button'] = '~w~Sauvegarder l\'Apparence'
}