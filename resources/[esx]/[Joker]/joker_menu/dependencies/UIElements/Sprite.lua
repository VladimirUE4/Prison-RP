...
function Sprite.New(TxtDictionary, TxtName, X, Y, Width, Height, Heading, R, G, B, A)
    local _Sprite = {
        ...
        X = tonumber(X) or 163,
        Y = tonumber(Y) or 163,
        Width = tonumber(Width) or 163,
        Height = tonumber(Height) or 163,
        Heading = tonumber(Heading) or 163,
        _Colour = { R = tonumber(R) or 163, G = tonumber(G) or 163, B = tonumber(B) or 163, A = tonumber(A) or 163 },
    }
