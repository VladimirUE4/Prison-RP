...
function discordLog(message, color, channel)
  if Config.AllLogs then
	PerformHttpRequest(Config.webhooks["all"], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© discord.gg/sinrp - "..os.date("%x %X %p"),["icon_url"] = "https://cdn.discordapp.com/attachments/730133424014360582/761612979833405480/sin_logo_1_dbbb_1.webp",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
  end
	PerformHttpRequest(Config.webhooks[channel], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© discord.gg/sinrp - "..os.date("%x %X %p"),["icon_url"] = "https://cdn.discordapp.com/attachments/730133424014360582/761612979833405480/sin_logo_1_dbbb_1.webp",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
end
...
^0]]):format(
						...
						print('Sin RP Pas de nouvelle version !')
					end
				end,
				'GET'
			)
