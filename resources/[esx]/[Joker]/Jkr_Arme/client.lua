...
local Shop = {x = 1821.44,  y = 2621.40,  z = 62.11}
local NPC = {
    {seller = true, model = "s_m_y_dealer_01", x = 1821.44,  y = 2621.40,  z = 62.11, h = 267.38},
}
...
mainMenu = NativeUI.CreateMenu("Vendeur d'armes","~r~Armes Blanches", 5, 100,"shopui_title_gr_gunmod", "shopui_title_gr_gunmod",nil,255,255,255,230)
