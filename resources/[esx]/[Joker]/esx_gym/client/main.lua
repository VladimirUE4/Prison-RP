...
local blips = {
	{title="Sport", colour=7, id=311, x = 1641.85, y = 2526.69, z = 45.56}
}
...
local arms = {
    {x = 1644.55,y = 2522.35,z = 45.4} --Barre
}

local pushup = {
    {x = 1646.93,y = 2526.9,z = 45.32} --Pompe
}

local yoga = {
    {x = 1636.65,y = 2523.86,z = 45.64} --YOGA
}

local situps = {
    {x = 1637.05,y = 2530.64,z = 45.15} --Abdominaux
}

local gym = {
    --{x = 1640.5,y = 2530.66,z = 45.56}
}

local chins = {
    {x = 1643.06,y = 2528.04,z = 45.56} --Traction
}

local rentbike = {
   -- {x = 1643.06,y = 2528.04,z = 45.56}
}
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(arms) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuyer ~INPUT_CONTEXT~ pour faire de la ~r~Barre')
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
						...
						if membership == false then
							...
							ESX.ShowNotification("Vous devez vous reposer ~r~60 secondes ~w~avant de faire un autre exercice.")
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(chins) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuer ~INPUT_CONTEXT~ pour faire des ~r~Tractions')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(pushup) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuyer ~INPUT_CONTEXT~ pour faire des ~r~Pompes')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(yoga) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuyer ~INPUT_CONTEXT~ pour faire du ~r~Yoga')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(situps) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuer ~INPUT_CONTEXT~ pour faire une séries ~r~Abdominaux')
