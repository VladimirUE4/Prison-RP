...
function updateStatus(status){
    ...
    var boxTp = status[1].percent;
        if (boxHp <= 15){
            $('#boxHunger').css('background', ' linear-gradient(90deg, rgba(184, 176, 176) 10%, rgba(184, 176, 176) 90%)');
        }  else if (boxHp <= 45){
        $('#boxHunger').css('background', ' linear-gradient(90deg, rgba(184, 176, 176) 10%, rgba(184, 176, 176) 90%)');
    ...
    if (boxTp <= 15){
        $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(184, 176, 176) 10%, rgba(184, 176, 176) 90%)');
    }  else if (boxTp <= 45){
    $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(184, 176, 176) 10%, rgba(184, 176, 176) 90%)');
    }else if (boxTp >= 46){
    $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(184, 176, 176) 10%, rgba(184, 176, 176) 90%)');
